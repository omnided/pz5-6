...
## **Скріншоти с постман**
![Отримання списку лікарів](../images/Снимок_экрана_(1733).png)
![Створення мед картки](../images/Снимок_экрана_(1734).png) 
![Отримання списку медкарт](../images/Снимок_экрана_(1735).png)
![Видалення медкарти](../images/Снимок_экрана_(1736).png)
![Перевірка](../images/Снимок_экрана_(1737).png)
![Створення пацієнта](../images/Снимок_экрана_(1738).png)

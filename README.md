...
## **Скріншоти с постман**
![Отримання списку лікарів](../image/Снимок_экрана_(1733).png)
![Створення мед картки](../image/Снимок_экрана_(1734).png) 
![Отримання списку медкарт](../image/Снимок_экрана_(1735).png)
![Видалення медкарти](../image/Снимок_экрана_(1736).png)
![Перевірка](../image/Снимок_экрана_(1737).png)
![Створення пацієнта](../image/Снимок_экрана_(1738).png)

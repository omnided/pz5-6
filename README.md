...
## **Скріншоти с постман**
![Отримання списку лікарів](image/3.png)
![Створення мед картки](image/4.png) 
![Отримання списку медкарт](image/5.png)
![Видалення медкарти](image/6.png)
![Перевірка](image/7.png)
![Створення пацієнта](image/8.png)

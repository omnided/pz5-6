...
## **Скріншоти с постман**
![Отримання списку лікарів](./image/Снимок экрана (1733).png)
![Створення мед картки](./image/Снимок экрана (1734).png)
![Отримання списку медкарт](./image/Снимок экрана (1735).png)
![Видалення медкарти](./image/Снимок экрана (1736).png)
![Перевірка](./image/Снимок экрана (1737).png)
![Створення пацієнтов](./image/Снимок экрана (1738).png)
